            ...
            <div class=" col-md-3 form-group">
              ...
              <div class="col-sm-10">
                <select name="province" class="form-select" required aria-label="Default select example">
                  ...
                  <option value="<?php echo $province_data['Lcode']; ?>"><?php echo $province_data['pradesh_name']; ?>
                  </option>
                </select>
              </div>
            </div>
            ...
            <div class=" col-md-3 form-group">
              ...
              <div class="col-sm-10">
                <select name="region" required class="form-select" aria-label="Default select example">
                  ...
                  <option value="<?php echo $region_data['Lcode']; ?>"><?php echo $region_data['region_name']; ?>
                  </option>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-9 elected-candidate-form">
              <div class="row">
                <div class="col-md-4 form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required id="elected-name" name="elected-name"
                ...
                <div class=" col-md-4 form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required id="elected-party" name="elected-party"
                ...
                <div class=" col-md-4 form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="elected-vote" name="elected-vote"
